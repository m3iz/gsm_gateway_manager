...
SET_CONTROL_REQ_DTR = b'\x07'                 # Request DTR pyqtSignal State
SET_CONTROL_DTR_ON = b'\x08'                  # Set DTR pyqtSignal State ON
SET_CONTROL_DTR_OFF = b'\x09'                 # Set DTR pyqtSignal State OFF
SET_CONTROL_REQ_RTS = b'\x0a'                 # Request RTS pyqtSignal State
SET_CONTROL_RTS_ON = b'\x0b'                  # Set RTS pyqtSignal State ON
SET_CONTROL_RTS_OFF = b'\x0c'                 # Set RTS pyqtSignal State OFF
...
MODEMSTATE_MASK_CD = 128            # Receive Line pyqtSignal Detect (also known as Carrier Detect)
MODEMSTATE_MASK_RI = 64             # Ring Indicator
MODEMSTATE_MASK_DSR = 32            # Data-Set-Ready pyqtSignal State
MODEMSTATE_MASK_CTS = 16            # Clear-To-Send pyqtSignal State
MODEMSTATE_MASK_CD_CHANGE = 8       # Delta Receive Line pyqtSignal Detect
